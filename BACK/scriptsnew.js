...
function buttonz(pagevalue){
	...
	setTimeout(function (){if(pagevalue == 'm0'){
		...
		document.getElementById('inside').innerHTML='<img src="res/pic.png" ID="pic">';
		}else if(pagevalue == 'm1'){
		document.getElementById('disp').innerHTML="TEXT<br>TEXT<br>";
		document.getElementById('inside').innerHTML='<img src="res/pic2.png" ID="pic">';
		}else if(pagevalue == 'm2'){
		document.getElementById('disp').innerHTML="TEXT<br>TEXT<br>";
		document.getElementById('inside').innerHTML='<img src="res/cane.jpg" ID="pic">';
